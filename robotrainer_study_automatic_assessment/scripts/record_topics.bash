...
CONFIG_YAML=$(rospack find robotrainer_study_automatic_assessment)/config/topics_to_record.yaml
STATUS_FILE=$(rospack find robotrainer_study_automatic_assessment)/status/user_study_manager.status
BAG_FOLDER=$(rospack find robotrainer_study_automatic_assessment)/data
